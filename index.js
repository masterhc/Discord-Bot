...
bot.on('ready', ()=>{
  ...
  function changeActivity(){ 
   ...
   let counter = bot.channels.find('name', "👐bem-vindo").fetchMessage(445251380639170560).reactions.count
   console.log(`Rem is up and ready to serve on ${bot.channels.find('name', "👐bem-vindo").fetchMessage(445251380639170560).reactions.users[counter-1]}`);
