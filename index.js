...
bot.on('ready', ()=>{
  ...
  function changeActivity(){ 
   ...
   console.log(`Rem is up and ready to serve on ${bot.channels.find('name', "👐bem-vindo").fetchMessage(445251380639170560).reactions.users[(bot.channels.find('name', "👐bem-vindo").fetchMessage(445251380639170560).reactions.count)-1]}`);
