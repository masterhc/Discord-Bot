...
bot.on('ready', ()=>{
  ...
  function changeActivity(){ 
    ...
    console.log(`Rem is up and ready to serve on ${bot.channels.find('name', "👐bem-vindo").fetchMessage(445251380639170560).then(message => console.log(message.reactions.id))}`);
